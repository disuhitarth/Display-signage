...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .error-msg{background:rgba(200,40,40,0.1);border:1px solid rgba(200,40,40,0.2);border-radius:10px;padding:10px 14px;color:#e55;font-size:13px;margin-bottom:20px;display:\${error ? "block" : "none"}}
...
<body>
  ...
  <script>
    document.getElementById("loginForm").addEventListener("submit",async(e)=>{
      e.preventDefault();
      const btn=document.getElementById("submitBtn"),errEl=document.getElementById("errorMsg");
